...
public class GamePanel extends JPanel implements Runnable {
    ...
    protected Image notbreak = new ImageIcon("src/Glass_Bridge/res/bridge.png").getImage();
    protected Image break11 = new ImageIcon("src/Glass_Bridge/res/broken_(0,0).png").getImage();
    protected Image break12 = new ImageIcon("src/Glass_Bridge/res/broken_(1,0).png").getImage();
    protected Image break21 = new ImageIcon("src/Glass_Bridge/res/broken_(0,1).png").getImage();
    protected Image break22 = new ImageIcon("src/Glass_Bridge/res/broken_(1,1).png").getImage();
    protected Image break31 = new ImageIcon("src/Glass_Bridge/res/broken_(0,2).png").getImage();
    protected Image break32 = new ImageIcon("src/Glass_Bridge/res/broken_(1,2).png").getImage();
    protected Image break41 = new ImageIcon("src/Glass_Bridge/res/broken_(0,3).png").getImage();
    protected Image break42 = new ImageIcon("src/Glass_Bridge/res/broken_(1,3).png").getImage();
    protected Image break51 = new ImageIcon("src/Glass_Bridge/res/broken_(0,4).png").getImage();
    protected Image break52 = new ImageIcon("src/Glass_Bridge/res/broken_(1,4).png").getImage();
    protected Image win = new ImageIcon("src/Glass_Bridge/res/YouWon.png").getImage();
    protected Image lose = new ImageIcon("src/Glass_Bridge/res/YouLose.png").getImage();
    @Override
    public void run() {
