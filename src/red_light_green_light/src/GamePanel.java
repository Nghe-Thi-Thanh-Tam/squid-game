...
public class GamePanel extends JPanel implements Runnable {
    ...
    // MAP SETTING
    public final int width = screenWidth;
    ...
    public GameLogic gameLogic; // Reference to the GameLogic class

    public void setGreenLight(boolean greenLight) {
        gameLogic.setGreenLight(greenLight);
    }
    ...
    public void paintComponent(Graphics g) {
        ...
        g2.fillRect(0, startY - 1 + offsetY, width, 3);
